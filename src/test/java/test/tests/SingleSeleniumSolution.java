...
public class SingleSeleniumSolution
{
   ...
   private static final double RED_RATIO = 0.2126f;
   private static final double BLUE_RATIO = 0.0722f;
   private static final double GREEN_RATIO = 0.7152f;
   private static final int BYTE_MASK = 0x000000FF;
   private static final float PIXEL_ERROR_LIMIT = 1000;
   private static final double PIXEL_ERROR_THRESHOLD_RATIO = 0.2;
   private static final int DEFAULT_KERNEL_RADIUS = 2;
   ...
   public static SingleSeleniumSolution buildWebDriver(String url, String browserName, Method method)
   {
      ...
      String description = a[0].toString().split("description=")[1].split(", retryAnalyzer=")[0];
      System.gc();
      log.info("");
      log.info("=========================================================");
