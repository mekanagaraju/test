...
{
   protected static final Logger log = LoggerFactory.getLogger(CommonFunctions.class);
   private final WebDriver webDriver;
   private static final int TEN = 10, FIVE = 5;
   private static final String CSS_PREFIX = "css=", VALUE = "value";
   private static String sysEnv;


   public CommonFunctions(WebDriver weDriver)
   {
   ...
   public static CommonFunctions buildWebDriver(String url, String browserName, Method method)
   {
      ...
      wd.get(url);
      log.info("Building WebDriver: " + wDriver.getBrowsersNameVersion().trim() + " { Platform: " + wDriver.discoverPlatform().toString() + " }");
   ...
   public static CommonFunctions buildRemoteWebDriver(String url, String browserName, Method method)
   {
      ...
      log.info("=========================================================");
      CommonFunctions wDriver = new CommonFunctions(wd);
      wd = buildRemoteWebDriver(browserName);
      wd.get(url);
   ...
   public void setIEAuthentication(String userName, String password)
   {
    ...
    */
   public void assertTrue(int expectedValue, int actualValue, String message)
   {
   ...
   /**
    * This method will compare two images pixel which were specified
    *
    * @param fileA - Expeted file
    * @param fileB - Actual file
    *
    *           Image match acceptance criteria will be '%'
    *
    **/
   public float imagePixelComparison(File fileA, File fileB)
   {
      float percentage = 0;
      try
      {
   ...
   /**
    * This method will compare two images which were specified
    *
    * @param fileA - Expeted file
    * @param fileB - Actual file
    *
    *           Image match acceptance criteria will be '=='
    **/
   public boolean imageComparison(File fileA, File fileB)
   {
      try
      {
         BufferedImage biA = ImageIO.read(fileA);
