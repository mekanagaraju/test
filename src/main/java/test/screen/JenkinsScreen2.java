...
public class JenkinsScreen2
{
   ...
   public JenkinsScreen2(WebDriver webDriver)
   {
   ...
   private void grabRedJobResult(String jobName)
   {
      ...
      int buildE = webController.getElementsCount(count);
      buildE = buildE - 1;
      ...
      failure: for (int f = 2; f <= failuresCount; f++)
      {
         ...
         else
         {
            ...
            else
            {
               ...
               {
                  text.add("NOT AVAILABLE");// Browser
               }
            }
         }
   ...
   public void setDataToExcel(int sheetNo)
   {
      ...
      setValueIntoCell(6, 0, "||Browser Type", hedder, sheetNo);
      setValueIntoCell(7, 0, "||Build No", hedder, sheetNo);
      setValueIntoCell(8, 0, "||Machine Name", hedder, sheetNo);
      ...
      for (ArrayList<String> d : atfFailures)
      {
         ...
         {
            int column = 1;
            setValueIntoCell(column++, row, "|", white, sheetNo);
            setValueIntoCell(column++, row, "|" + h, white, sheetNo);
            setValueIntoCell(column++, row, "|" + d.get(1), white, sheetNo);
            setValueIntoCell(column++, row, "|" + d.get(2), white, sheetNo);
            setValueIntoCell(column++, row, "|" + d.get(4), white, sheetNo);
            setValueIntoCell(column++, row, "|", white, sheetNo);
            setValueIntoCell(column++, row, "|", white, sheetNo);
            setValueIntoCell(column++, row, "|", white, sheetNo);
            print = "|" + d.get(3).toString() + "|";
   ...
   public void sendEmail(String appName)
   {
      ...
      switch (appName)
      {
         ...
         case "MyServices":
            ...
            break;
         case "OBP":
            to = "nagaraju.meka@accenture.com,d.negi@accenture.com";
            break;
         case "PMT":
